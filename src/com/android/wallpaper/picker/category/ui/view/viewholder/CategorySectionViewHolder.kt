...
class CategorySectionViewHolder(itemView: View, private val windowWidth: Int) :
    ...
    // title for the section, added for cases when we need to a stand-alone title like "Collections"
    private val sectionTitle: TextView = itemView.requireViewById(R.id.section_title)

    // category header is for all things photos, since this view holder is not for photos, we will
    // simply mark it as gone.
